      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
          ...
          <div className="mt-4 flex items-center gap-3">
            <a href="https://www.youtube.com/@yourchannel" aria-label="YouTube" className="rounded-md p-2 hover:bg-white/10 transition">
            ...
            <a href="https://www.instagram.com/yourhandle" aria-label="Instagram" className="rounded-md p-2 hover:bg-white/10 transition">
            ...
            <a href="https://x.com/yourhandle" aria-label="X" className="rounded-md p-2 hover:bg-white/10 transition">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li><a href="/bike-info" className="hover:text-white transition">Bike Info & CC Limits</a></li>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li><a href="https://racers.world/" target="_blank" rel="noreferrer" className="hover:text-white transition">RACERS Clubman Licence</a></li>
            <li><a href="/rules" className="hover:text-white transition">Rules & Code of Conduct</a></li>
            <li><a href="/merch" className="hover:text-white transition">Sliders & Merchandise</a></li>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-3 text-sm">
            <li className="flex items-center gap-2"><PhoneIcon className="h-4 w-4 text-zinc-400" /><a href="tel:0451348876" className="hover:text-white transition">0451 348 876</a></li>
            <li className="flex items-center gap-2"><EnvelopeIcon className="h-4 w-4 text-zinc-400" /><a href="mailto:info@qldminimoto.com" className="hover:text-white transition">info@qldminimoto.com</a></li>
